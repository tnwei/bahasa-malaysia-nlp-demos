# Tracking BM NLP model repo and demo status

Model repos are at https://huggingface.co/malay-huggingface

## BERT models

| Model name              | Repo status | Inference API     | Demo status | Link to model repo
| ----------------------- | --------- | ----------------- | ----------- | ----
| bert-tiny-bahasa-cased  | Ready     | Ready (fill-mask) | Ready, https://huggingface.co/spaces/malay-huggingface/bert-x-bahasa-cased       | https://huggingface.co/malay-huggingface/bert-tiny-bahasa-cased
| bert-base-bahasa-cased  | Ready     | Ready (fill-mask) | Ready, https://huggingface.co/spaces/malay-huggingface/bert-x-bahasa-cased       | https://huggingface.co/malay-huggingface/bert-base-bahasa-cased     
| bert-large-bahasa-cased | Ready     | Ready (fill-mask) | Ready, https://huggingface.co/spaces/malay-huggingface/bert-x-bahasa-cased       | https://huggingface.co/malay-huggingface/bert-large-bahasa-cased
...
| Model name             | Repo status | Inference API     | Demo status | Link to model repo
| ---------------------- | --------- | ----------------- | ----------- | ----
| gpt2-117M  | Pending model upload    | Not Ready | Not Ready       | https://huggingface.co/malay-huggingface/gpt2-117M
| gpt2-345M  | Pending model upload     | Not Ready | Not Ready       | https://huggingface.co/malay-huggingface/gpt2-345M     
...
| Model name              | Repo status | Inference API     | Demo status | Link to model repo
| ----------------------- | --------- | ----------------- | ----------- | ----
| bigbird-small-abstractive-summarization-bahasa-cased  | Pending model upload     | Require tagging to summarization | Not Ready       | https://huggingface.co/malay-huggingface/bigbird-small-abstractive-summarization-bahasa-cased
| bigbird-base-abstractive-summarization-bahasa-cased  | Pending model upload     | Require tagging to summarization | Not Ready       | https://huggingface.co/malay-huggingface/bigbird-base-abstractive-summarization-bahasa-cased
| bigbird-small-translation-en-ms-cased  | Pending model upload     | Require tagging to translation | Not Ready       | https://huggingface.co/malay-huggingface/bigbird-small-translation-en-ms-cased
| bigbird-small-translation-ms-en-cased | Pending model upload     | Require tagging to translation | Not Ready       | https://huggingface.co/malay-huggingface/bigbird-small-translation-ms-en-cased
| bigbird-base-translation-en-ms-cased  | Pending model upload     | Require tagging to translation | Not Ready       | https://huggingface.co/malay-huggingface/bigbird-base-translation-en-ms-cased
| bigbird-base-translation-ms-en-cased | Pending model upload     | Require tagging to translation | Not Ready       | https://huggingface.co/malay-huggingface/bigbird-base-translation-ms-en-cased
